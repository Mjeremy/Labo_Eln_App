...
Le rôle de la diode D1 est forcé le courant à passer de la capacité C1 à la diode D2 (comme l'indique la flèche orange) lorsque C1 se décharge.
...
Le rôle de la diode D2 est forcé le courant à passer dans la résistance R3 (comme l'indique la flèche orange) lorsque C2 se décharge.
